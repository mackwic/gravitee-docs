...
Gateway configuration. The field `unknown-expire-after` specify the visibility duration (in second) of a gateway with the state *unknown*. (default value : 7 days)
